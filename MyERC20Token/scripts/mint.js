 ...
 async function main() {
    const replace_contractAddress = "0x63430ad790771DDDD4543054770afD512802B222";
    const [signer] = await hre.ethers.getSigners();
    const replace_contractFactory = await hre.ethers.getContractFactory("Dezman");
    const contract = replace_contractFactory.attach(replace_contractAddress);
  
    const replace_functionName = "mint";
    const replace_functionArgs = ["0xC7bc15B67Cc9Dac03470ea809Eb38cA17d756503","100000000000000000000"]; // 100 tokens with 18 decimal places
